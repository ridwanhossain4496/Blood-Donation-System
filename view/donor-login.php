...
<body><center>
	<div id="full">
		<div id="inner_full">
			...
			<div id="body">
				<br><br>
				<h1 align="center" style="color: #01007C">Login as Donor</h2>
				...
				<?php
					if(isset($_POST['sub'])){
						$un=$_POST['un'];
						$ps=$_POST['ps'];
						$q=$db->prepare("SELECT * FROM donor WHERE uname='$un' AND pass='$ps'");
						$q->execute();
				...
				<ul><h2 align="center" style="color: white; font-style:italic;">Don't Have Account? Please Register.</h2>
					<li><a href="donor-reg.php" style="text-decoration: none; color: green;">Register</a></li>
				</center>				
			</div>
		</div>
	</div>
