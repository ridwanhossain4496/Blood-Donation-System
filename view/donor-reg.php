...
<body>
	<div id="full">
		<div id="inner_full">
			...
			<div id="body">
				<h1 align="center" style="color: #01007C">Register as a Donor</h2><br>
				<center>
				<div id="form">
					...
					<?php
						if(isset($_POST['sub'])){
							$uname=$_POST['uname'];
							$pass=$_POST['pass'];
							$q=$db->prepare("INSERT INTO donor (uname, pass) 
							VALUES(:uname,:pass)");
							$q->bindValue('uname',$uname);
							$q->bindValue('pass',$pass);
							if($q->execute()){
								echo "Registration Successfull as a DONOR ";
							}
							else{
								echo "Donor Registration Unsuccessfull";
							}
						}						
					?>
				</div>
